...
In this section we study the cohomology groups when $G$ is a profinite group. %(For basics on profinite groups see Section~\ref{profinite}.) %Uncomment this if this is compiled with the Galois theory chapters.
